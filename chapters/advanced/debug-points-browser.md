...
<img src="./graphics/debug-points-browser.png" alt="Opening Debug Point Browser via the World menu" width="700" height="auto">
...
<img src="./graphics/debug-points-browser-variable.png" alt="Debug Point Browser with a selected debug point set on an instance variable" width="700" height="auto">
...
<img src="./graphics/debug-points-browser-filter-by-name.png" alt="Filtering the displayed debug points by name, thanks to an input field" width="700" height="auto">
...
<img src="./graphics/debug-points-object-centric-popover-button.png" alt="Popover button menu, suggesting to insall object-centric debug points for an object on all instance variables" width="750" height="auto">
...
<img src="./graphics/debug-points-object-centric-raw-context-menu.png" alt="Context menu on an instance variable in the raw inspector, suggesting to install object-centric debug points for the selected variable only" width="350" height="auto">
...
<img src="./graphics/debug-points-object-centric-break-on-call.png" alt="Context menu on a method in the meta tab of the inspector, suggesting to install objec-centric debug points for the selected method" width="350" height="auto">
...
<img src="./graphics/debug-points-set-object-centric-scope-modal.png" alt="Modal opened to choose a debug point whose scope should be changed to the inspected object" width="700" height="auto">
